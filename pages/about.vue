...
<div>
  <sui-segment vertical class="stripe">
    <div class="ui text container">
      ...
      <p>Since our humble beginning, we hope to attract more members and grow our competition rankings. </p>
  ...
  <sui-segment vertical class="stripe">
    <div class="ui middle aligned stackable grid container">
      <div class="row">
       ...
       <div class="row">
        <div class="eight wide column">
          <h3 class="ui header">
            2024 CCDC Qualifiers Team
          </h3>
          <p>
            Cyber@UCR places 6th and makes it into WRCCDC Regionals!
          </p>
          <p>
            Captain: Nathan Melwani, Team: Kareem Shehada, Mark Ghebrial, AnPhu Dung, Joshua Hsu, Justin Lee, Thomas Li, Gryphon Kumfert
          </p>
        </div>
        <div class="six wide right floated column">
          <img class="ui large bordered rounded image" src="~/assets/competitions/ccdcTeam2024.jpg" />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="six wide right floated column">
          <img class="ui large bordered rounded image" src="~/assets/competitions/cptcTeam2019.jpeg" />
        </div>
      </div>
      <div class="row">
        <div class="eight wide column">
      ...
      <div class="row">
        ...
        <div class="six wide right floated column">
          <img class="ui large bordered rounded image" src="~/assets/competitions/ccdcTeam2018.jpg" />
        </div>
      </div>
      <div class="row">
        <div class="eight wide column">
